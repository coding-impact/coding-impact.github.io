...
[此階段完成品 DEMO](https://coding-impact.github.io/game_tutorial/02.%20遊戲初步設計/)

我們知道，要開發一個遊戲，我們首先要對整個目標有一個稍微清楚一點的想像。由於我已經寫好了整個遊戲，我們可以嘗試一邊玩 DEMO，一邊試著分析，我們要如何設計整個遊戲、整個遊戲會有哪些部件。
